...
namespace MonoGame.OpenAL
{
    ...
    internal class AL
    {
        ...
        private static IntPtr GetNativeLibrary()
        {
            ...
            {
                case OS.Linux: return FuncLoader.LoadLibraryExt("libopenal.so.1");
                case OS.MacOSX: return FuncLoader.LoadLibraryExt("libopenal.1.21.1.dylib");
                case OS.Windows: return FuncLoader.LoadLibraryExt("soft_oal.dll");
