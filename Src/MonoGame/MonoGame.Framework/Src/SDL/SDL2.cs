...
public static class Sdl
{
    ...
    private static IntPtr GetNativeLibrary()
    {
        ...
        {
            case OS.Linux: return FuncLoader.LoadLibraryExt("libSDL2-2.0.so.0");
            case OS.MacOSX: return FuncLoader.LoadLibraryExt("libSDL2-2.0.0.dylib");
            case OS.Windows: return FuncLoader.LoadLibraryExt("SDL2.dll");
    ...
    public static class Display
    {
        ...
        private static d_sdl_getpixelformatname SDL_GetPixelFormatName = FuncLoader.LoadFunction<d_sdl_getpixelformatname>(NativeLibrary, "SDL_GetPixelFormatName");

        public static string GetPixelFormatName(uint format)
        {
            return InteropHelpers.Utf8ToString(GetError(SDL_GetPixelFormatName(format)));
        }
