...
namespace Microsoft.Xna.Framework.Input
{
    ...
    public struct GamePadThumbSticks
    {
        ...
        {
            // Apply dead zone
            _left = ApplyDeadZone(leftDeadZoneMode, leftThumbDeadZone, ref leftPosition);
            _right = ApplyDeadZone(rightDeadZoneMode, rightThumbDeadZone, ref rightPosition);
        ...
        private Vector2 ApplyDeadZone(GamePadDeadZone deadZoneMode, float deadZone, ref Vector2 thumbstickPosition)
        {
