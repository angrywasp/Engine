...
namespace Microsoft.Xna.Framework
{
    public struct Color : IEquatable<Color>
    {
        ...
        public Color(Vector4 color) : this((byte)(color.X * 255), (byte)(color.Y * 255), (byte)(color.Z * 255), (byte)(color.W * 255)) { }

        public Color(Vector3 color) : this((byte)(color.X * 255), (byte)(color.Y * 255), (byte)(color.Z * 255), 255) { }
