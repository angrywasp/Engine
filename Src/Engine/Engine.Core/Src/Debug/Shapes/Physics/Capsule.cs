...
{
    public class DebugPhysicsCapsule : IDebugShape
    {
        ...
        public DebugPhysicsCapsule(Capsule shape)
        {
            this.shape = shape;
            Update();
        }
        ...
        public void Update()
        {
            ...
            {
                (vertices, indices) = ShapeGenerator.Capsule(shape.Radius, shape.Length, 32, shape.IsDynamic ? Color.Red : Color.Blue);
