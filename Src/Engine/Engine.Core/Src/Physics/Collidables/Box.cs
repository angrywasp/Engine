...
namespace Engine.Physics.Collidables
{
    ...
    {
        private DebugPhysicsBox debugShape;

        [JsonProperty] public float Width { get; set; } = 1.0f;
        [JsonProperty] public float Height { get; set; } = 1.0f;
        [JsonProperty] public float Length { get; set; } = 1.0f;

        public Box(bool isDynamic)
        {
        ...
        {
            var shape = new BepuBox(Width, Height, Length);
            ...
            Log.Instance.Write("Physics box shape added to scene");
        ...
        public override void AddToBuilder(ref CompoundBuilder builder) =>
            builder.Add(new BepuBox(Width, Height, Length), Pose.ToRigidPose(), Mass);
        ...
        public override void RemoveFromScene()
        {
            ...
            Log.Instance.Write("Physics box removed from scene");
        }
