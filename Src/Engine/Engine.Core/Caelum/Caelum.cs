...
namespace Caelum
{
    ...
    public class CaelumUtils
    {
         ...
         */
        static public Vector3 XAxis = new Vector3(1, 0, 0);
        static public Vector3 ZAxis = new Vector3(0, 1, 0);
        static public Vector3 YAxis = new Vector3(0, 0, 1);

        static public Vector3 unit_Scale = new Vector3(1, 1, 1);

        /** Wraps some Colors to NAE
         *  @note: ColorBlack is equal to Color.Zero
         */
        static public Color ColorWhite = Color.White;
        static public Color ColorBlack = Color.Black;
        static public Color ColorRed = Color.Red;
        static public Color ColorGreen = Color.Green;
        static public Color ColorBlue = Color.Blue;
        ...
        static public Quaternion GenerateQuat(Vector3 axis, Degree angle)
        {
            return GenerateQuat(axis, angle.ToRadians());
        }
        ...
        static public Quaternion GenerateQuat(Vector3 axis, Radian angle)
        {
            float sin_a = MathF.Sin(angle / 2);
            float cos_a = MathF.Cos(angle / 2);

            Quaternion q = new Quaternion(axis * sin_a, cos_a);
